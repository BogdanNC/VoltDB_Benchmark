...
WHERE g.type = 'female'
    AND d.document_date BETWEEN '2015-09-17 00:00:00' AND '2015-09-18 00:00:00';  -- Replace 'female' with the actual gender you want to filter by
